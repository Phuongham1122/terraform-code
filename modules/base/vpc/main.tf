...
resource "aws_subnet" "private_app_subnet_az1" {
  vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-app-subnet-az1
  availability_zone        = data.aws_availability_zones.available_zones.names[0]
...
resource "aws_subnet" "private_app_subnet_az2" {
  vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-app-subnet-az2
  availability_zone        = data.aws_availability_zones.available_zones.names[2]
  map_public_ip_on_launch  = false
...
resource "aws_subnet" "private_data_subnet_az1" {
  vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-data-subnet-az1
  availability_zone        = data.aws_availability_zones.available_zones.names[0]
  map_public_ip_on_launch  = false 
...
resource "aws_subnet" "private_data_subnet_az2" {
 vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-data-subnet-az2
...
resource "aws_subnet" "private_data_subnet_az3" {
 vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-data-subnet-az3
  availability_zone        = data.aws_availability_zones.available_zones.names[2]
  map_public_ip_on_launch  = false 
